...
<body>
    <div class="login-clean">
        <form action="php/login.php" method="post">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="color: #fffff;background-color: #208f8f;">Log In</button></div><a href="register.php" class="forgot">Don't have account? Register here</a></form>
    </div>
