...
<body>
    <div class="row register-form" style="margin-left:150px;">
        <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
            <form class="form-horizontal custom-form" style="background-color: #208f8f;width: 542px;height: 846px;" action="php/register.php" method="post">
                ...
                <button class="btn btn-default submit-button" type="submit" name="btnSubmit">Submit</button></form>
        </div>
    </div>
